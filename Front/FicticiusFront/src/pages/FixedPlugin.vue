...
export default {
  ...
  data() {
    return {
      ...
      sidebarImages: [
        {
          image: `${process.env.VUE_APP_BASE_URL}/img/sidebar-1.jpg`,
          active: false,
        },
        {
          image: `${process.env.VUE_APP_BASE_URL}/img/sidebar-2.jpg`,
          active: true,
        },
        {
          image: `${process.env.VUE_APP_BASE_URL}/img/sidebar-3.jpg`,
          active: false,
        },
        {
          image: `${process.env.VUE_APP_BASE_URL}/img/sidebar-4.jpg`,
          active: false,
        },
      ],
    };
